...
from ..core.text import nonewlines
...
class Approach:
    ...
    def get_sources_content(
        ...
        if use_semantic_captions:
            ...
            return [
                (self.get_citation((doc.sourcepage or ""), use_image_citation)) + ": Confidence Score=" + (str(doc.searchscore) or " ") + ": " + nonewlines(doc.content or "")
                for doc in results
            ]
