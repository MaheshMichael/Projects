...
class File:
    ...
    def __init__(self, content: IO, acls: Optional[dict[str, list]] = None,name:str=None,id:str=None):
    ...
    def filename_to_id(self):
        if self.id is not None:
            ...
            filename_ascii = re.sub("[^0-9a-zA-Z_-]", "_", self.name)
            filename_hash = base64.b16encode(self.name.encode("utf-8")).decode("ascii")
...
class ADLSGen2ListFileStrategy(ListFileStrategy):
    ...
    async def list_paths(self) -> AsyncGenerator[str, None]:
        async with DataLakeServiceClient(
            'DefaultEndpointsProtocol=https;AccountName=107glautomation;AccountKey=0y0JsbhfpO7ODpoema+6Q6EV4NmI8w1VYmi6xhMl5+NJNKSti1eQJbspkJhnUA1M4fxk/MYhckkk+AStfz8qcw==;EndpointSuffix=core.windows.net'
