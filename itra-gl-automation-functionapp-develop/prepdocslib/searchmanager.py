...
class Section:
    ...
    def __init__(self, split_page: SplitPage, content: File,pdf_page_no:int,section:str, category: Optional[str] = None):
        self.split_page = split_page
        self.content = content
        self.category = category
        # self.bouning_box = bounding_box
    ...
    async def create_index(self):
        ...
        async with self.search_info.create_search_index_client() as search_index_client:
            ...
            fields = [
                ...
                SimpleField(name="pdf_page_num",type="Edm.Int32", filterable=True, facetable=True),
                SimpleField(name="section",type="Edm.String", filterable=True, facetable=True)
                # ComplexField(name="words", collection=True, fields=[word_info]),
            ]
            if self.use_acls:
                fields.append(
                    SimpleField(
                ...
                documents = [
                    {
                        ...
                        # "boundingbox":section.split_page.bounding_box,
